...
import { getDocLabels, BismillahIcon, GoldDivider, FONTS } from './templateUtils';
    ...
    >
      ...
      <div className="text-center relative z-10 mb-6" data-pdf-section="header">
        <div className="flex justify-center mb-1">
          <BismillahIcon className="w-24 h-10" color={deepGreen} />
        </div>
        <p
          className="text-xs font-semibold tracking-wider uppercase mb-1"
          style={{ color: deepGreen, fontFamily: FONTS.marcellus }}
        >
          {data.religiousHeading || '|| In the Name of Allah, Most Gracious, Most Merciful ||'}
        </p>
        <h1
          className="text-2xl font-bold uppercase tracking-widest"
          style={{ color: deepGreen, fontFamily: FONTS.cinzel }}
        >
      ...
      >
        ...
        <div className="flex-1 space-y-1.5 min-w-0">
          <h2
            ...
            style={{ color: deepGreen, fontFamily: FONTS.playfair }}
          >
            {data.fullName}
          </h2>
          {data.profileHeadline && (
            <p className="text-xs italic" style={{ color: deepGreen }}>
              "{data.profileHeadline}"
            </p>
          )}
          ...
          >
            ...
            />
            <ExportFieldRow label={lbl.height} value={data.heightFeet} labelColor={deepGreen} />
            <ExportFieldRow label={lbl.weight} value={data.weight} labelColor={deepGreen} />
            <ExportFieldRow label={lbl.bloodGroup} value={data.bloodGroup} labelColor={deepGreen} />
            <ExportFieldRow label={lbl.complexion} value={data.complexion} labelColor={deepGreen} />
            <ExportFieldRow
            ...
            <ExportFieldRow
              ...
              labelColor={deepGreen}
            />
            <ExportFieldRow label={lbl.subCaste} value={data.subCaste} labelColor={deepGreen} />
            <ExportFieldRow label={lbl.motherTongue} value={data.motherTongue} labelColor={deepGreen} />
            <ExportFieldRow
              label={lbl.diet}
              value={data.diet && data.diet !== 'prefer_not_to_disclose' ? data.diet.replace('_', ' ') : undefined}
              labelColor={deepGreen}
            />
            <ExportFieldRow label={lbl.nativePlace} value={data.nativePlace} labelColor={deepGreen} />
            <ExportFieldRow
          ...
          <div data-pdf-section="family-details">
            ...
            {data.additionalFamilyMembers?.length > 0 && (
              <div
                ...
                style={{
                  borderTop: `1px solid ${deepGreen}30`,
                  paddingLeft: '6px',
                }}
              >
